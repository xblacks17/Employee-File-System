                    ...
                    <div class="row">
                        <div class="col-lg-3 mb30">
                            <div class="card p-4 rounded-5">
                                ...
                                <ul class="menu-col">
                                    ...
                                    <li><a href="/current" class="active"><i class="fa fa-user"></i>Current Employee</a></li>
                        ...
                        <div class="col-lg-9">                          
                            ...
                            <div class="card p-4 rounded-5 mb25">
                                ...
                                <a class="btn btn-primary" href="/add" role="button" style="position:absolute;top:20px;right:40px;">+ Add Employee</a>
                                  <thead>
                                    <tr>
                                  ...
                                  <tr>
                                      ...
                                      <td><span class="d-lg-none d-sm-block">Employee Name</span><span class="bold"><a href="/profile">Jeep Renegade</a></span></td>
